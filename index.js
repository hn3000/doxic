...
(function (doxic) {
    ...
    function configure(options) {
        ...
        options.sources = options._.map(function (src) {
    ...
    function parse(src, code, options) {
        ...
        switch (parser) {
            default:
            case 'commonmark':
                return parseCommonMark(src, code, options);
            case 'adhoc':
                return parseAdhocMarkdown(src, code, options);
            case 'language':
                return parseLanguage(src, code, options);
        }
    }
    ...
    function write(src, sections, options) {
        ...
        var html = options.templateFun({
            sources: options.sources.map(function (e) {
                return e.filename;
            }),
